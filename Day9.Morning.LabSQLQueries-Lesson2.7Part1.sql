...
For 2020, the rental duration will be 3 days, with an offer price of 2.99€ and a replacement cost of 8.99€ (these are all fixed values for all movies for this year). The catalog is in a CSV file named films_2020.csv that can be found at files_for_lab folder.
...
SHOW GLOBAL VARIABLES;
 ...
 -- IGNACIO CODE -  didnt work
load data local infile '‪C:/Users/kyear/Documents/Personal/Education/Ironhack/Week2/9SQL/dataV3_Lesson_2.7_lab/files_for_part1/films_2020.csv'
into table films_2020
fields terminated by ',';

 -- ANNA CODE - NEITHER WORKED
load data local infile '‪C:/Users/kyear/Documents/Personal/Education/Ironhack/Week2/9SQL/dataV3_Lesson_2.7_lab/files_for_part1/films_2020.csv'
into table films_2020
fields terminated BY ‘,’
ENCLOSED BY ‘“’
